...
//                ROS_INFO("hour: %d, min: %d",ptm->tm_hour,ptm->tm_min);
            stringstream dt;
            dt << ptm->tm_year+1900 << setw(2) << setfill('0') << ptm->tm_mon+1 << setw(2) << setfill('0') << ptm->tm_mday << "-" << setw(2) << setfill('0') << ptm->tm_hour << ":" << setw(2) << setfill('0') << ptm->tm_min << ":" << setw(3) << setfill('0') << ptm->tm_sec << "." << (int)m.getTime().nsec/1000000;
